...
import "../../assets/styles/Legal/PrivacyPolicy.css"; // Importation du fichier CSS spécifique à la charte de confidentialité

// Composant principal pour afficher la Charte de Confidentialité
const PrivacyPolicy = () => {
	...
	return (
		// Conteneur principal pour la charte de confidentialité, centré avec des marges et une largeur définie
		<div className="privacy-policy-container col-10 mx-auto mt-5 mb-5">
			...
			<p>Pour exercer ces droits, veuillez nous contacter à l'adresse suivante : <a href={toEmail}>{email}</a>.</p>

			{/* Section 7 - Modifications de la Charte de Confidentialité */}
...
// Exportation du composant PrivacyPolicy pour l'utiliser dans d'autres parties de l'application
